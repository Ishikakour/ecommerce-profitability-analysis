...
# Scale across all rows so KPI totals match without breaking a single order.
...
# Hit the profit KPI without flipping signs. Extra loss goes to Clothing
# (the planted drag); extra profit goes to non-Clothing.
